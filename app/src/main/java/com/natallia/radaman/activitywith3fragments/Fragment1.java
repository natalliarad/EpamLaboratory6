...
public class Fragment1 extends Fragment {
    ...
    private int color;
    private Button button2Fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View frView = inflater.inflate(R.layout.fragment_fragment1, container, false);
        frView.findViewById(R.id.fragment1_layout).setBackgroundColor(color);
        button2Fragment = (Button) frView.findViewById(R.id.buttonToSecondFragment);
        button2Fragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity) getActivity()).fragmentChoice(2);
            }
        });
